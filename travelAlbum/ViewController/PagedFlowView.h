...
@interface PagedFlowView : UIView<UIScrollViewDelegate>{
    ...
    NSInteger           _pageCount;  //总页数,在layoutSubviews中设置
...
@property(nonatomic,unsafe_unretained)   id <PagedFlowViewDataSource> dataSource;
@property(nonatomic,unsafe_unretained)   id <PagedFlowViewDelegate>   delegate;
